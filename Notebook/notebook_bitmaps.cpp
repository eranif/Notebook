...
static size_t xml_res_size_0 = 338;
...
static size_t xml_res_size_2 = 362;
static unsigned char xml_res_file_2[] = {
60,63,120,109,108,32,118,101,114,115,105,111,110,61,34,49,46,48,34,32,101,
110,99,111,100,105,110,103,61,34,85,84,70,45,56,34,63,62,10,60,33,45,45,
32,119,120,114,99,32,47,110,32,78,111,116,101,98,111,111,107,95,73,110,
105,116,95,66,105,116,109,97,112,115,32,47,99,32,47,118,32,47,111,32,110,
111,116,101,98,111,111,107,95,98,105,116,109,97,112,115,46,99,112,112,32,
110,111,116,101,98,111,111,107,95,98,105,116,109,97,112,115,46,120,114,
...
112,34,32,110,97,109,101,61,34,110,111,116,101,98,111,111,107,45,100,97,
114,107,45,120,34,62,110,111,116,101,98,111,111,107,95,98,105,116,109,97,
112,115,46,99,112,112,36,98,105,116,109,97,112,115,95,102,105,108,101,99,
...
120,66,105,116,109,97,112,34,32,110,97,109,101,61,34,110,111,116,101,98,
111,111,107,45,108,105,103,104,116,45,120,34,62,110,111,116,101,98,111,
111,107,95,98,105,116,109,97,112,115,46,99,112,112,36,98,105,116,109,97,
112,115,95,102,105,108,101,99,108,111,115,101,46,112,110,103,60,47,111,
...
void Notebook_Init_Bitmaps()
{
    ...
    XRC_ADD_FILE(wxT("XRC_resource/notebook_bitmaps.cpp$bitmaps_fileclose-dark.png"), xml_res_file_0, xml_res_size_0, wxT("image/png"));
    XRC_ADD_FILE(wxT("XRC_resource/notebook_bitmaps.cpp$bitmaps_fileclose.png"), xml_res_file_1, xml_res_size_1, wxT("image/png"));
    XRC_ADD_FILE(wxT("XRC_resource/notebook_bitmaps.cpp$._notebook_bitmaps.xrc"), xml_res_file_2, xml_res_size_2, wxT("text/xml"));
    wxXmlResource::Get()->Load(wxT("memory:XRC_resource/notebook_bitmaps.cpp$._notebook_bitmaps.xrc"));
}
